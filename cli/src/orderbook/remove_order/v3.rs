use crate::{
    cli::registry::{IOrderBookV3, Order},
...
mod test {
    ...
    use crate::orderbook::{add_order::v3::test::check_io, remove_order::v3::remove_order};
    use ethers::{
        abi::{ParamType, Token},
        types::{H160, U256},
    };
    ...
    pub async fn test_remove_order() -> anyhow::Result<()> {
        ...
        let remove_order_tx = remove_order(order_config, orderbook_address, rpc_url, None)
            .await
            .unwrap();
        ...
        let evaluable_tuple =
            ParamType::Tuple([ParamType::Address, ParamType::Address, ParamType::Address].to_vec());
