...
pub async fn gas_price_oracle(api_key : Option<String> ,chain_id : u64) -> anyhow::Result<(f64,f64)>{
    ...
    let fatest = response.estimate_from_category(&GasCategory::Fastest).unwrap() ;
