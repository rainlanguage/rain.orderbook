...
<div class="flex w-full items-center mb-8">
  <div class="flex-1">
    <Breadcrumb aria-label="Default breadcrumb example">
      ...
      {/each}
      <BreadcrumbItem spanClass="ms-1 text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-300" linkClass="ms-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ms-2 dark:text-gray-400 dark:hover:text-white capitalize">{title}</BreadcrumbItem>
    </Breadcrumb>
  </div>
