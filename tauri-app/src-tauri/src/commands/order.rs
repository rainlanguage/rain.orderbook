...
pub async fn order_add<R: Runtime>(
    ...
    let add_order_args = AddOrderArgs::new_from_deployment(dotrain, deployment, None).await?;
    add_order_args
...
"#,
        ...
        assert_eq!(
            ...
            vec![IOV2 {
                token: token1,
                vaultId: B256::from(U256::from(0x01)),
            }]
        );
        assert_eq!(
            ...
            vec![IOV2 {
                token: token2,
                vaultId: B256::from(U256::from(0x02)),
            }]
        );
    }
    ...
    async fn test_order_remove_calldata_ok() {
        ...
        let expected = "";

        assert_eq!(calldata.encode_hex(), expected);
    }
