...
describe('Rain Orderbook JS API Package Bindgen Tests - Raindex Client', async function () {
	...
	describe('Orders', async function () {
		...
		it('should get order by hash', async function () {
			...
			assert.equal(order.vaults[0].balance.format18().value, '12');
			...
			assert.equal(order.vaults[1].balance.format18().value, '10');
			...
			assert.equal(order.vaults[2].balance.format18().value, '13');
