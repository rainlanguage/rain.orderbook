...
describe('Rain Orderbook JS API Package Bindgen Tests - Gui', async function () {
	...
	describe('state management tests', async () => {
		let serializedState =
			'H4sIAAAAAAAA_41OQQqAIBB0LTpELwkKLfI_RRJS2CGLnp_QqgkdnMuws7M7A-RFhWzkYZpJ6VnpBVBjpPxur3E7JUWlcJt9lZoThxx5YK2ILJ23ZMicMfj_Vrv8WyQijgr3fSKobweunlUhTDbjAW5KAKMyAQAA';
		let gui: DotrainOrderGui;
		beforeAll(async () => {
			mockServer
				.forPost('/rpc-url')
...
${dotrain}`;
			...
			await gui.saveSelectTokenAddress('token2', '0x3333333333333333333333333333333333333333');
