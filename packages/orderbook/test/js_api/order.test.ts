...
describe('Rain Orderbook JS API Package Bindgen Tests - OrderSubgraph', async function () {
	...
	it('should fetch a single order', async () => {
		...
		try {
			const result: SgOrder = await getOrder(mockServer.url + '/sg1', order1.id);
