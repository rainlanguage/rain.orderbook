...
export declare const defaultWagmiConfig: ({ appName, appDescription, appUrl, appIcon, autoConnect, chains, connectors, projectId, supportedChains }: DefaultConfigProps) => {
