...
export const getNewOrderConfig = (
  ...
  isSuccess: (addOrders: any) => addOrders?.length > 0
});
...
export const getRemoveOrderConfig = (
  ...
  isSuccess: (removeOrders: any) => removeOrders?.length > 0
});
