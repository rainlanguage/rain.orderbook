...
#[tokio::test]
async fn loads_sidebar(ctx: &mut WebdriverTestContext) {
...
#[test_context(WebdriverTestContext)]
#[tokio::test]
async fn opens_settings_page_on_first_launch(ctx: &mut WebdriverTestContext) {
...
#[test_context(WebdriverTestContext)]
#[tokio::test]
async fn opens_orders_page_when_valid_network_and_orderbook_settings(ctx: &mut WebdriverTestContext) {
