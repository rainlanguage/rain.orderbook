...
use crate::{
    ...
    erc20::ERC20,
    raindex_client::{
        filters::vaults_filter::GetVaultsFilters, orders::RaindexOrderAsIO,
...
impl RaindexClient {
    ...
    pub async fn get_vaults(
        &self,
        #[wasm_export(
            param_description = "Optional filtering options including owners, hide_zero_balance, tokens, and chain_ids"
        )]
        ...
        let chain_ids = filters
            .as_ref()
            .and_then(|f| f.chain_ids.clone())
