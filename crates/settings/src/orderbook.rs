...
impl OrderbookCfg {
    pub fn validate_address(address: &str) -> Result<Address, ParseOrderbookConfigError> {
        Address::from_str(address).map_err(ParseOrderbookConfigError::AddressParseError)
    }
...
pub enum ParseOrderbookConfigError {
...
impl ParseOrderbookConfigError {
    pub fn to_readable_msg(&self) -> String {
        match self {
            ParseOrderbookConfigError::AddressParseError(err) =>
                format!("The orderbook address in your YAML configuration is invalid. Please provide a valid EVM address: {}", err),
            ParseOrderbookConfigError::NetworkNotFoundError(network) =>
            ...
            ParseOrderbookConfigError::SubgraphNotFoundError(subgraph) =>
