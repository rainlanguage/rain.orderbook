...
pub enum ParseConfigError {
    #[error(transparent)]
    ParseNetworkCfgError(#[from] ParseNetworkConfigError),
    #[error(transparent)]
    ParseOrderbookCfgError(#[from] ParseOrderbookConfigError),
    #[error(transparent)]
    ParseTokenCfgError(#[from] ParseTokenConfigError),
    #[error(transparent)]
    ParseOrderCfgError(#[from] ParseOrderConfigError),
    #[error(transparent)]
    ParseDeployerCfgError(#[from] ParseDeployerConfigError),
    #[error(transparent)]
    ParseScenarioCfgError(#[from] ParseScenarioConfigError),
    #[error(transparent)]
