...
import {OrderBookV6ArbConfig, WrongTask} from "../../src/abstract/OrderBookV6ArbCommon.sol";
...
contract OrderBookV6ArbTaskGatedCheckTaskHashWrongTaskTest is Test {
    function testCheckTaskHashRevertsWrongTask(bytes memory constructBytecode, bytes memory runtimeBytecode) external {
        ...
        ChildOrderBookV6ArbTaskGated child = new ChildOrderBookV6ArbTaskGated(OrderBookV6ArbConfig(constructTask));
